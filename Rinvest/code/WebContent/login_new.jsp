	...
	<div class="row clearfix">
		...
		<ul class="breadcrumb">
			...
			<div class="alert alert-success alert-dismissable">
				...
				<h4>
					注意!
				</h4> <strong>睿步温馨提示</strong> 请保证密码强度以保护账户安全 
			</div>
			...
			<form class="form-horizontal" role="form" action="/TomcatTest/Login" method="post" >
				...
				<div class="form-group">
                    ...
                    <% String loginMsg = (String)session.getAttribute("loginMsg");
                       String TimeoutMsg = (String)session.getAttribute("timeout");%>
                    <%
                    if(loginMsg != null) { 
                    out.print(loginMsg);
                    ...
                    if(TimeoutMsg != null) { 
                        out.print(TimeoutMsg);
                        out.println("<script  charset=UTF-8 language='javascript'>alert( '3');</script>");
