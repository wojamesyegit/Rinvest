		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">睿步投资专家系统</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							 <a href="#" onclick="display_alert()">国内市场</a>
						</li>
						<li>
							 <a href="#" onclick="display_alert()">环球市场</a>
						</li>
						<li>
							 <a href="#" onclick="display_alert()">投资推荐</a>
						</li>
						<li class="dropdown">
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							 <a href="login_new.jsp">登录</a>
						</li>
						<li>
							 <a href="regist_new.html">注册</a>
						</li>
			...
			<div class="jumbotron">
				...
				<p>
					 <a class="btn btn-primary btn-large" href="login_new.jsp">马上进入</a>
				</p>
			</div>
			<div class="carousel slide" id="carousel-501922" data-interval = 2500>
